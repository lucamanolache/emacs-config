...
(setq user-full-name "Luca Manolache"
      user-mail-address "luca1230@gmail.com")
...
(custom-set-faces!
  ...
  '(org-document-title :inherit outline-1 :height 1.5 :weight bold))
...
(after! org
  (setq org-capture-templates
        (append org-capture-templates
                '(("c" "Coffee")
                  ("ct" "Tried Coffee" entry
                   (file+headline "~/org/coffee.org" "Coffee Journal")
                   "* %U - ☕ %^{Coffee name}\n  Roaster: %^{Roaster}\n  Amount: %^{Amount|8oz|12oz|16oz}\n  Dialing Notes:\n  %^{Dialing notes}\n  Taste Notes: %?"
                   :empty-lines 1)
                  ("cw" "Coffee Wishlist" entry
                   (file+headline "~/org/coffee.org" "Coffee Wishlist")
                   "* %U - ☕ %^{Coffee name}\n  Roaster: %^{Roaster}\n  Origin: %^{Origin}\n  Link: %^{Link}\n  Notes: %?"
                   :empty-lines 1)))))
...
(map! :leader
      (:prefix ("c" . "code")
       :desc "Aider transient menu" "g" #'aidermacs-transient-menu))
